...
type TeamRoundStats struct {
	TotalRounds, RoundsWon, RoundsLost                  int
	TRounds, CTRounds, TWins, CTWins                    int
	PistolRounds, EcoRounds, ForceRounds, FullBuyRounds int
	PistolWins, EcoWins, ForceWins, FullBuyWins         int
	AntiEcoRounds, AntiEcoWins                          int
	TPlants, TPlantWins                                 int
	TPlantWinPct                                        sql.NullFloat64
	RetakeOpportunities, RetakeWins                     int
	RetakeSuccessPct                                    sql.NullFloat64
}
